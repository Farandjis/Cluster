...
# SAÉ S3 - Brand Guidelines

<br><br>
This document contains all the graphic information about the website.
...
The buttons will be rectangular with rounded edges.
They will be in salmon color, with the lighter shade (#fdada4) on the outside and the darker shade (#fa8072) on the inside. These shades will switch when the mouse cursor hovers over them.
<br><br>

- <b><a name="p3b"></a>b) Nav Barre</b>
<br><br>

The Nav Bar will have the dark gray color (#4d4641) since it contrasts well with our logo.
On the Nav Bar, the logo will be placed on the left for the mobile version and in the center for the desktop version. The rest of the Nav Bar will contain links to the pages.
<br><br>

- <b><a name="p3c"></a>c) Global style</b>
<br><br>

The overall style adheres to the following conditions:<br><br>
    - Background in soft gray<br>
    - Titles in orange<br>
    - Text in dark gray<br>
<br>
Below is an example of the style layout:
<br><br>
...
The values we want to convey through our site are:<br>
    ...
    - Comfort of the graphical interface<br>
    - Simplicity of use<br>

Our goal is to highlight the scientific and mathematical aspects of the web application. <br>However, the interface must remain simple and comfortable to enhance accessibility.<br>

Through the chosen logo, we want users to understand that our site is based on distributed computing.
