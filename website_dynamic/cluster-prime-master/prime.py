# note les commentaires en fr sont les miens
...
end_number = int(sys.argv[1]) # on récupère les arguments lors de l'exécution du fichier 
...
if my_rank == 0:
    ...
    "nodes": cluster_size,
    "time_elapsed": end,
    "primes_found": len(merged_primes),
    "all_primes": merged_primes
    }
